                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <form action="<?php site_url('dashboard/addJadwalAset') ?>" method="post" enctype="multipart/form-data">
                            <?php $this->load->view('_partials/fg_minggu'); ?>
                            <?php $this->load->view('_partials/fg_bulan'); ?>
                            <?php $this->load->view('_partials/form_group', $data = array('nama_atribut'=>'Tahun', 'nama_tanpa_spasi'=>'tahun','nilai_atribut'=>''));?>
                            <div class="form-group">
                                <label for="satuan">Jenis Perawatan</label>
                                <input class="form-control <?php echo form_error('jenis_perawatan') ? 'is-invalid':'' ?>" type="text" name="jenis_perawatan" min="0" placeholder="Jenis Perawatan" />
